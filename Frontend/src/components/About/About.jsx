                  ...
                  <div class="flex flex-wrap ">
                      <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                          <div class="relative">
                              ...
                              <div
                                  class="absolute z-10 hidden w-full h-full bg-green-400 rounded-bl-[80px] rounded -bottom-6 right-6 lg:block">
                              </div>
                              <div
                                  class="absolute z-50 text-green-400 transform -translate-y-1/2 cursor-pointer top-1/2 left-[46%] hover:text-green-500">
